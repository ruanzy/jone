...
public class FtpUtil
{
	...
	public static void addProtocolCommandListener()
	{
	...
	public static UploadStatus upload(String local, String remote) throws IOException
	{
		...
		if (remote.contains("/"))
		{
			...
			if (mkdir(remote, ftpClient) == UploadStatus.Create_Directory_Fail)
			{
	 ...
	 * @throws IOException
	 */
	public static UploadStatus mkdir(String remote, FTPClient ftpClient) throws IOException
	{
	 ...
	 * @throws IOException
	 */
	public static UploadStatus uploadFile(String remoteFile, File localFile, FTPClient ftpClient, long remoteSize)
			throws IOException
	{
		UploadStatus status;
		// 显示进度的上传
