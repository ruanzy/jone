...
public class DynamicSQL1
{
	...
	static
	{
		...
		try
		{
			URL url = DynamicSQL1.class.getClassLoader().getResource("sqls");
			...
			for (File file : xmls)
			{
				...
				is = DynamicSQL1.class.getClassLoader().getResourceAsStream(path);
				if (is == null)
				{
	...
	public static void main(String[] args)
	{
		...
		SQL s = DynamicSQL1.getSQL("log.selectAll", param);
