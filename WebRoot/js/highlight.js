    ...
    window.HighLighter = {
        ...
        */
        highLight: function (lang, theme, code) {
            lang = typeof lang === 'string' ? window.HighLighter.langs[lang] : undefined;
            if (!lang) {
                return;
            }
            theme = typeof theme === 'string' ? window.HighLighter.themes[theme] : undefined;
            if (!theme) {
                return;
            }
        ...
        */
        getThemeArray: function () {
            var arr = [],
                item;
            for (item in HighLighter.themes) {
                arr.push(item);
            }
            return arr;
        }
